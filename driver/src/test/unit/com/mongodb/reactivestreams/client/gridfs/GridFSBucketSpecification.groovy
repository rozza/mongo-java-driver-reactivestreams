...
class GridFSBucketSpecification extends Specification {
    ...
    def 'should have the same methods as the wrapped GridFSBucket'() {
        given:
        def wrapped = (com.mongodb.async.client.gridfs.GridFSBucket.methods*.name).sort()
    ...
    def 'should call the underlying GridFSBucket when getting bucket meta data'() {
        given:
        def wrapped = Mock(com.mongodb.async.client.gridfs.GridFSBucket)
    ...
    def 'should call the wrapped openUploadStream'() {
        ...
        def uploadStream = Stub(com.mongodb.async.client.gridfs.GridFSUploadStream)
        def wrapped = Mock(com.mongodb.async.client.gridfs.GridFSBucket)
        def bucket = new GridFSBucketImpl(wrapped)
    ...
    def 'should call the wrapped openDownloadStream'() {
        ...
        def fileId = new BsonObjectId()
        def downloadStream = Stub(com.mongodb.async.client.gridfs.GridFSDownloadStream)
        def wrapped = Mock(com.mongodb.async.client.gridfs.GridFSBucket)
        def bucket = new GridFSBucketImpl(wrapped)
